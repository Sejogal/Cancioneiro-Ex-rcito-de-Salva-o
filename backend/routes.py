...
from sessao import criarSessao
from model import usuario

router = APIRouter(prefix="/conteudo", tags=["Letras"])
...
@router.get("/letras")
async def mostrarTodasLetras():
    """
    Essa rota irá listar todas letras do Cancioneiro exército de salvação
    """
    ...
    return(
        ...
        },
        {
            ...
            "tb": 158,
            "selecionado": True,
            "estrofe1": "Àquele que, de amor por nós, à morte Se entregou\nE,pela mão tomando-nos, do mal nos libertou,\nQue nos levou de novo a Deus, o Deus de todo o amor,\nA Cristo soem, pelos céus, os ecos de louvor.",
            "estrofe2": "Louvado seja Quem nos quis de Deus aproximar\nE, em reino e sacerdotes Seus, com sangue consagrar.\nLouvado seja Quem o dom do Espírito nos deu;\nLouvado seja, pois que abriu a entrada para o céu.",
        ...
        },
        {
            ...
            "estrofe2": "Vem, destrói o que é falso,\nTudo o que é vão;\nVem, aos fracos concedendo\nPlena salvação!",
            "estrofe3": "Vem, reveste a Tua Igreja\nDe energia e luz;\nVem, atrai os pecadores\nAo Senhor Jesus.",
            "som": "",
...
async def mostrarTodasDoutrinas():

    """
    Essa rota irá listar todas doutrinas do cancioneiro exército de salvação
    """
    ...
    return(
        ...
        {
        "id": 0,
        "title":"Doutrinas Do Exército de Salvação",
        "message":"sucess",
        "conteudo":"1. CREMOS que as Escrituras do Velho e Novo Testa-mento foram dadas por inspiração de Deus e que somente elas constituem a regra divina da fé e prática cristã. \n\n2. CREMOS na existência de um único Deus, infinita-mente perfeito, Criador, Preservador e Governador de todas as coisas e único objetivo legitimo do culto religioso.\n\n3. CREMOS que há três pessoas na Divindade — Pai, Filho e Espirito Santo — indivisíveis em Sua essência e iguais em poder e glória. \n\n4. CREMOS que na pessoa de Jesus Cristo acham-se unidas as naturezas divina e humana, de modo que Ele é verdadeira e propriamente Deus e verdadeira e propriamente homem. \n\n5. CREMOS que nossos primeiros pais foram criados em estado de inocência, porém, pela sua desobedi-ência, perderam sua pureza e felicidade, e que, em conseqüência de sua queda, todos os homens tor-naram-se pecadores, totalmente depravados, e como tais incorrem com justiça na ira de Deus. \n\n6. CREMOS que o Senhor Jesus Cristo tem, por Seu sofrimento e Sua morte, feito expiação pelo mundo inteiro, para que todo aquele que quiser possa ser salvo. \n\n7. CREMOS que o arrependimento para com Deu fé em nosso Senhor Jesus Cristo e a regenera pelo Espírito Santo são necessários para a salvação \n\n8. CREMOS que somos justificados pela graça, medi-ante a fé em nosso Senhor Jesus Cristo, e que todo aquele que cré tem o testemunho em si mesmo. \n\n9. CREMOS que a continuação no estado de salvação depende da fé obediente e continua em Cristo. \n\n10. CREMOS que é privilégio de todos os crentes serem santificados em tudo, e que seu espirito, alma e cor-po podem ser conservados íntegros e irrepreensíveis até a vinda de nosso Senhor Jesus Cristo (I Ts. 5:23). \n\n11 CREMOS na imortalidade da alma, na ressurreição do corpo, no juízo final, na felicidade eterna dos jus-tos e no castigo eterno dos maus. "
    }
    )
...
@usuario_router.post("/registo")
async def registo(schema: usuarioSchema, sessao=Depends(criarSessao)):
    # Verificar se o usuário existe
    user = sessao.query(usuario).filter(usuario.email == schema.email).first()

    if user:
        raise HTTPException(status_code=400, detail="Usuário já existe")
    
    # ✅ Corrigido - use schema.nome e schema.email
